...
class IRYMManager:
    ...
    async def get_api_response(self, query: str, userId: str, user_context: dict = None, system_context: dict = None, history: list = None, metadata: dict = None):
        ...
        system_rules = (
            ...
            "You MUST output your response ONLY as a valid JSON object matching the requested schema.\n\n"
            "### INTERNAL TOOL CAPABILITIES (MANDATORY) ###\n"
            "You MUST generate documents (PDF, DOC, MD, PLAN, CV, PROPOSAL, SUMMARY) IMMEDIATELY when requested or when appropriate for the task.\n"
            "CRITICAL: Do NOT talk about generating files in the future tense (e.g., 'I will generate...'). You MUST include the 'GENERATE_DOCUMENT' action in the CURRENT response.\n"
            "CRITICAL: Do NOT return a 'NAVIGATE_TO_PAGE' action for a document you haven't generated yet. Use 'GENERATE_DOCUMENT' and the server will handle the URL.\n\n"
            ...
            "4. Build actions array: If a document is needed, include a GENERATE_DOCUMENT action with full content. Include RECOMMEND_HELPERS if experts are needed.\n"
            "5. Build responseText: Natural language reply confirming what you have just generated or matched.\n\n"
            ...
            "Response Schema:\n"
            "{\n"
            "  \"responseText\": \"Natural language reply here. Example: 'I have generated your Flutter study plan below and found 3 experts to help you.'\",\n"
            "  \"actions\": [\n"
            "    {\n"
            "      \"type\": \"GENERATE_DOCUMENT\",\n"
            "      \"priority\": 2,\n"
            "      \"payload\": {\n"
            "        \"documentType\": \"PDF | DOC | MD | PLAN | CV | PROPOSAL | SUMMARY\",\n"
            "        \"filename\": \"study_plan_flutter.pdf\",\n"
            "        \"content\": \"Full markdown or text content here.\",\n"
            "        \"topic\": \"Flutter Development (Only for PLAN/SUMMARY type)\"\n"
            "      }\n"
            "    },\n"
            "    {\n"
